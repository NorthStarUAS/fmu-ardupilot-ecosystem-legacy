...
bool link_t::parse_message( uint8_t id, uint8_t *buf, uint8_t message_size )
{
    bool result = false;
...
int link_t::write_ack( uint16_t sequence_num, uint8_t result )
{
